...
**版本**:v1.1
**位置**:`docs/PRODUCT_CONSTITUTION.md`
...
### 4.2 图像路由策略
- **Cover**: Nano Banana 主(快、省、不拒) → FAL 兜底
- **内页**: fal-kontext img2img(reference cover 保持角色一致)
- **不再用 OpenAI 主路径**(78% 拒绝率 + 慢 6 倍 + 贵 2 倍)
- **STYLE_SUFFIXES 童书化**:Sendak / Beatrix Potter / Quentin Blake / 1980s vintage / paper texture / no glossy
- **避免**:vibrant saturated / luminous glowing / high contrast(AI 完美感)
