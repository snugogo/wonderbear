# WO-V4-CHECK3: V4 Pro 调用链路验证(最小工单)
...
写一个 markdown 文件 `coordination/done/WO-V4-CHECK3-report.md`,**严格按以下结构,不要遗漏任何一项**:
...
5. 写 report 到 `/opt/wonderbear/coordination/done/WO-V4-CHECK3-report.md`
6. 完成
...
仅一个文件: `coordination/done/WO-V4-CHECK3-report.md`,严格按 §2 模板填充。
