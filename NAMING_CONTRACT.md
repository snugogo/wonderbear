# WonderBear 资产命名规范 · NAMING_CONTRACT v7.5

> **更新日期**：2026-04-24
> **总资产**：118 张 WebP + 7 个 SVG
...
| `bear_wings_spread.webp` | 双翼展开飞翔姿势（DialogueScreen 3A 等待说话状态）| medium |
| `bear_magic_wand.webp` | 举着魔法棒仰望（GeneratingScreen 可选增强）| medium |
...
### 2026-04-24 · v7.5
- 新增 `bear/bear_wings_spread.webp`（DialogueScreen 3A 小熊飞翔状态，双翼展开）
- 新增 `bear/bear_magic_wand.webp`（GeneratingScreen 可选增强，举魔法棒仰望）
- bear 目录总数从 35 张更新为 37 张
